...
from video_cloud_video import *
from video_and_events import *
...
if __name__ == '__main__':
    test_dir = '/Users/koukihisashi/Desktop/git/X-StarT_cloud_video/jenkins_git'  # 测试用例所在目录
    test_report = '/Users/koukihisashi/Desktop/python+selenium/ceshi018/report'  # 测试报告所在目录

    discover = unittest.defaultTestLoader.discover(test_dir, pattern='video*.py')      #从目录中执行所有带test_video的case
